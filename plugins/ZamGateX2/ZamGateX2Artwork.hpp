...
#ifndef BINARY_ZAMGATEX2ARTWORK_HPP
#define BINARY_ZAMGATEX2ARTWORK_HPP

namespace ZamGateX2Artwork
{
    ...
    const unsigned int zamgatex2Height   = 107;
}

#endif // BINARY_ZAMGATEX2ARTWORK_HPP
